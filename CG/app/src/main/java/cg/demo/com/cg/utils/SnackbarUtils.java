...
public class SnackbarUtils {
     ...
     * @param text
     */
    public static void showDefaultShortSnackbar(View parent, CharSequence text) {
     ...
     * @param text
     */
    public static void showDefaultLongSnackbar(View parent, CharSequence text) {
        snackbarWeakReference = new WeakReference<>(Snackbar.make(parent, text, Snackbar.LENGTH_LONG));
        Snackbar snackbar = snackbarWeakReference.get();
        snackbar.show();
    }
